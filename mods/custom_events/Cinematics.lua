...
function onUpdate()
	...
	doTweenAlpha('AlphaTween2', 'Health', 0, 0.1)
	doTweenAlpha('AlphaTween3', 'healthBar', 0, 0.1)
	doTweenAlpha('AlphaTween4', 'scoreTxt', 0, 0.1)
	doTweenAlpha('AlphaTween5', 'iconP1', 0, 0.1)
	doTweenAlpha('AlphaTween6', 'iconP2', 0, 0.1)
	doTweenAlpha('AlphaTween7', 'timeBar', 0, 0.1)
	doTweenAlpha('AlphaTween8', 'timeBarBG', 0, 0.1)
	...
	doTweenAlpha('AlphaTween2', 'Health', 0, 1.1)
	doTweenAlpha('AlphaTween3', 'healthBar', 1, 0.1)
	doTweenAlpha('AlphaTween4', 'scoreTxt', 1, 0.1)
	doTweenAlpha('AlphaTween5', 'iconP1', 1, 0.1)
	doTweenAlpha('AlphaTween6', 'iconP2', 1, 0.1)
	doTweenAlpha('AlphaTween7', 'timeBar', 1, 0.1)
	doTweenAlpha('AlphaTween8', 'timeBarBG', 1, 0.1)
