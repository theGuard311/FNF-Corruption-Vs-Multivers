...
setProperty('timeBar.color', getColorFromHex('3F69BC'))
end
...
IntroTagColor = '3F69BC'	--Color de la etiqueta al final de la caja.
...
function onCreate()
	...
	makeGraphic('JukeBoxTag', 300+15, 100, '3F69BC')
	...
	makeLuaText('JukeBoxSubText', 'by AzuriParker', 300, -305-15, 60)
