...
left_xml_name = 'Asriel RIGHT NOTE'
down_xml_name = 'Asriel DOWN NOTE'
up_xml_name = 'Asriel UP NOTE'
right_xml_name = 'Asriel LEFT NOTE'
...
name_of_character_xml = 'soul-canon-asriel'
name_of_character = 'soul-canon-asriel'
name_of_notetype = 'Duet_Note'
--name_of_notetype2 = ''
--altnotetype = ''
--altnotetype2 = ''
...
function onCreate()
	...
	if invisible == true then
		setPropertyLuaSprite(name_of_character, 'visible', false)
	end
end
...
function onEvent(name,value1,value2)
	if name == 'Play Animation' then 
		...
		if value1 == 'soul-true' then
		setPropertyLuaSprite(name_of_character, 'visible', true)
		end
	end
end