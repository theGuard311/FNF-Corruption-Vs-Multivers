...
setProperty('timeBar.color', getColorFromHex('981A35'))
end
...
IntroTagColor = '981A35'	--Color de la etiqueta al final de la caja.
...
function onCreate()
	...
	makeGraphic('JukeBoxTag', 300+15, 100, '981A35')
	...
	makeLuaText('JukeBoxSubText', 'by ChillySilver', 300, -305-15, 60)
