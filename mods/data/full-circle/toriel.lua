...
left_alt_xml_name = 'Asriel RIGHT NOTE'
down_alt_xml_name = 'Asriel DOWN NOTE'
up_alt_xml_name = 'Asriel UP NOTE'
right_alt_xml_name = 'Asriel LEFT NOTE'
...
name_of_character_xml = 'betty-2'
name_of_character = 'toriel'
name_of_notetype = 'Toriel_Note'
name_of_notetype2 = 'T-S_Note'
altnotetype = 'Duet_Note-3'
--altnotetype2 = ''
