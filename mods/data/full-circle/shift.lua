...
left_alt_xml_name = 'Chara RIGHT NOTE'
down_alt_xml_name = 'Chara DOWN NOTE'
up_alt_xml_name = 'Chara UP NOTE'
right_alt_xml_name = 'Chara LEFT NOTE'
...
name_of_character_xml = 'shift'
name_of_character = 'shift'
name_of_notetype = 'Duet_Note-3'
name_of_notetype2 = 'T-S_Note'
altnotetype = 'Shift_Note'
--altnotetype2 = ''
