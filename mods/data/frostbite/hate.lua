...
function onCreate()
	...
	luaSpriteAddAnimationByPrefix('spacebar', 'spacebar2', 'spacebar', 40, true);
	...
	setProperty('spacebar.alpha', 0.0);
...
if keyJustPressed('space') and yourtriallife > -1 then 
    ...
    if mechanic then
        ...
        if yourtriallife == 1 then
            doTweenY('typhdied','typhlosion',getProperty('typhlosion.y')+350,1,'expoIn')
        end
    end
