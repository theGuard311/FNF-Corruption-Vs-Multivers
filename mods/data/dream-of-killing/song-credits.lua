...
setProperty('timeBar.color', getColorFromHex('4CFF00'))
end
...
IntroTagColor = '4CFF00'	--Color de la etiqueta al final de la caja.
...
function onCreate()
	...
	makeGraphic('JukeBoxTag', 300+15, 100, '4CFF00')
	...
	makeLuaText('JukeBoxSubText', 'by AmenKing1999', 300, -305-15, 60)
