...
IntroTagColor = 'FFFFFF'	--Color de la etiqueta al final de la caja.
...
function onCreate()
	...
	makeGraphic('JukeBoxTag', 310+15, 100, 'FFFFFF')
	...
	makeLuaText('JukeBoxSubText', 'by Renx The Hedgehog', 350, -305-15, 60)
